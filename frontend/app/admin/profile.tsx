...
export default function AdminProfile() {
  ...
  const logout = () => {
    Alert.alert('Logout', 'Sign out of admin session?', [
...
const s = StyleSheet.create({
  ...
  identityCard: { backgroundColor: T.surface1, borderWidth: 1, borderColor: T.primary + '55', borderRadius: T.radius, padding: T.md, gap: T.xs, marginBottom: T.md },
  roleBadge: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: T.primary + '22', paddingHorizontal: 8, paddingVertical: 4, borderRadius: T.radiusSm },
  ...
  webRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: T.surface1, borderWidth: 1, borderColor: T.primary + '33', borderRadius: T.radius, padding: T.md, gap: T.sm },
