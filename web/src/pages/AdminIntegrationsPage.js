          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="rounded-lg bg-purple-600 hover:bg-purple-700 disabled:opacity-40 px-3 py-2 text-xs font-medium text-white inline-flex items-center gap-1"
              >
      ...
      >
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            className="rounded-lg bg-purple-600 hover:bg-purple-700 px-3 py-2 text-xs font-medium text-white inline-flex items-center gap-1"
          >
