  ...
  return (
    <div className="min-h-screen p-8 max-w-5xl mx-auto" data-testid="client-projects">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <div className="flex-1 min-w-[200px] relative">
          ...
          <input
            ...
            className="w-full bg-[#151922] border border-border rounded-xl pl-12 pr-4 py-3 text-white placeholder:text-muted-foreground focus:outline-none focus:border-blue-500/50"
          />
        </div>
        
        {/* Filter Tabs */}
        <div className="flex bg-[#151922] border border-border rounded-xl p-1">
        ...
        <select
          ...
          className="bg-[#151922] border border-border rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-blue-500/50 cursor-pointer"
        >
      ...
      {filteredItems.length === 0 ? (
        <div className="rounded-2xl bg-[#151922] border border-border p-12 text-center">
      ...
      {deleteModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-[#151922] border border-border rounded-2xl p-6 max-w-md w-full mx-4">
...
const ProjectCard = ({ item, onOpen, onDelete }) => {
  ...
  return (
    <div 
      className="group rounded-2xl bg-[#151922] border border-border p-5 hover:border-border transition-all"
    >
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2 shrink-0 ml-4">
          ...
          <button
            onClick={onOpen}
            className="px-4 py-1.5 bg-muted hover:bg-white/15 text-white text-xs font-medium rounded-lg border border-border hover:border-border transition-all"
